...
- **Tendermint / CometBFT**: three-step lock-precommit-commit on a $2f+1$ quorum over $3f+1$ replicas. Robust to $f < n/3$ but lock semantics impose timeout-tuning complexity and a multi-round commit cost. Minimmit trades $f < n/3$ for $f < n/5$ in exchange for one-round finalisation.
